...
export default function SettingsForm({
    ...
    const onChangeOldPassword = useCallback((event: any)=>{
        setInitialValues((prev: any)=>update(prev, {
            oldPassword: event.target.value
        }))
    },[setInitialValues]);

    const onChangeNewPassword = useCallback((event: any)=>{
        setInitialValues((prev: any)=>update(prev, {
            newPassword: event.target.value
        }))
    },[setInitialValues]);

    const onChangeConfirmPassword = useCallback((event: any)=>{
        setInitialValues((prev: any)=>update(prev, {
        ...
        <Formik
            ...
            {()=>(
                <Form className="p-4">
                    ...
                    <div className="col-4">
                            <GroupBox
                                title={translate("SETTINGS_FORM_USER_INFO_TITLE")}
                                >
                                <div className="row">
                        ...
                        <div className="col-4">
                            <GroupBox
                                title="SETTINGS_FORM_USER_LANGUAGE_TITLE"
                                >
                                      <RadioGroupField
                                        name="language"
                        ...
                        <div className="col-4">
                            <GroupBox
                                title="SETTINGS_FORM_RESET_PASSWORD_TITLE"
                                >
                                    <div className="row">
                                    <div className="col-12 my-2">
                                        <InputField 
