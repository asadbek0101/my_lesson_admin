...
export default function SidebarItem({
    ...
    return (
        <div className="sidebar-item-wrapper">
            <div className={`sidebar-item ${url.includes(link)? " active-sidebar-item" : ""} ${className}`} onClick={()=>{
            ...
            {menu === AppMenuType.Opened && (
                <div className={`${child && url.includes(link)? "sidebar-item-child" : "closed-sidebar-item-child"}`}>
                    {child}
                </div>
            )}
        </div>
