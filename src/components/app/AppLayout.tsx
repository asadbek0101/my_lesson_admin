...
export default function AppLayout({
    ...
    return (
        <div className="app-layout-container">
            <div className={`app-sidebar ${menuType === AppMenuType.Closed ? "close-app-sidebar-menu" : "" }`}>
                <AppSidebarWrapper/>
            </div>
            <div className={`app-pages ${menuType === AppMenuType.Closed ? "full-app-pages" : ""}`}>
                <div className="app-pages-header">
                    <AppHeaderWrapper 
                        onChangeMenu={()=>{
                            dispatch(switchMenuType({ menuType:  menuType === AppMenuType.Opened ? AppMenuType.Closed : AppMenuType.Opened}))
                        }}
                        onChangeLogout={logout}
                    />
                </div>
                <div className="app-pages-page">
                    {children}
                </div>
            </div>
        </div>
