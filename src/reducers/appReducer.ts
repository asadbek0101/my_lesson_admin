...
export function switchTotalPageCount(meta: SwitchTotalPageCountMeta): PerformAction<SwitchTotalPageCountMeta> {
  return { type: ReducerActions.SwitchTotalPageCount, meta };
}

export function switchTotalRowCount(meta: SwitchTotalRowCountMeta): PerformAction<SwitchTotalRowCountMeta> {
